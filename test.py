...
url = f"{str('http://147.47.39.144:8500').rstrip('/')}/api/v1/prediction/activate_autocontrol/cmp_task_001"
resp = requests.get(url, params={"inline_base64": str('True').lower()}, timeout=15)
